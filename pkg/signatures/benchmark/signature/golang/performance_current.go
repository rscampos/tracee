...
type performanceCurrent struct {
	processMemFileRegexp *regexp.Regexp
	cb                   detect.SignatureHandler
}

func NewperformanceCurrent() (detect.Signature, error) {
	return &performanceCurrent{
		processMemFileRegexp: processMemFileRegexp,
	}, nil
}

func (sig *performanceCurrent) Init(ctx detect.SignatureContext) error {
	sig.cb = ctx.Callback

	return nil
}

func (sig *performanceCurrent) GetMetadata() (detect.SignatureMetadata, error) {
...
func (sig *performanceCurrent) GetSelectedEvents() ([]detect.SignatureEventSelector, error) {
...
func (sig *performanceCurrent) OnEvent(event protocol.Event) error {
	// event example:
...
func (sig *performanceCurrent) OnSignal(s detect.Signal) error {
	return nil
}
func (sig *performanceCurrent) Close() {}
